...
const myBot = ['ub5abe828cd964292195c3c59d6322033','ue4daf2885c9b02e9580a2d48c96b477d'];
...
\n";
        ...
        if(txt === '!ว่าง' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === '!ว่าง' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
